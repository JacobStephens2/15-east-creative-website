...
<!DOCTYPE html>
<!-- saved from url=(0037)https://<?php echo DOMAIN; ?>/portfolio/ -->
 ...
 */
  ...
  <link data-react-helmet="true" rel="stylesheet" href="./portfolio_files/oxs7yjf.css">
  <link rel="preconnect" href="https://www.googletagmanager.com/">
  <link rel="dns-prefetch" href="https://www.googletagmanager.com/">
  <link href="./portfolio_files/css" rel="stylesheet">
  <link as="script" rel="preload" href="./portfolio_files/webpack-runtime-a3031d37eff3e66bd590.js">
  <link as="script" rel="preload" href="./portfolio_files/framework-626f952c4a8c68f4bf53.js">
  <link as="script" rel="preload" href="./portfolio_files/app-3c9a821799db070428a3.js">
  <link as="script" rel="preload" href="./portfolio_files/commons-b1feb129729e34a11e63.js">
  <link as="script" rel="preload"
    href="./portfolio_files/d4ad233efeb1d959420253442063e6db7488fdeb-54bbfad46877c3bb23dd.js">
  <link as="script" rel="preload" href="./portfolio_files/component---src-pages-index-js-c42c1743ea4d36556642.js">
...
<body>
  <div id="___gatsby">
          ...
          <div class="header">
            <div class="container">
              <div class="logo"><a href="https://<?php echo DOMAIN; ?>/"><img height="36px"
                    alt="Serif - A Gatsby Business Theme" src="./portfolio_files/logo.svg"></a></div>
              <div class="logo-mobile"><a href="https://<?php echo DOMAIN; ?>/"><img height="36px"
                    alt="Serif - A Gatsby Business Theme" src="./portfolio_files/logo-mobile.svg"></a></div>
              <div id="main-menu-mobile" class="main-menu-mobile ">
                <ul>
                  <li><a href="https://<?php echo DOMAIN; ?>/about/">ABOUT</a></li>
                  <li><a aria-current="page" class="active" href="https://<?php echo DOMAIN; ?>/portfolio/">WORK</a></li>
            ...
            <div class="container">
              <div class="row justify-content-start">
                <div class="col-12 col-lg-10 order-2 order-md-1">
                  <div>
                    <h1>the good people who do good work that we keep talking about...</h1>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div id="portfolio-samples" class="container pb-6">
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6 mb-1">
                <div class="card service service-teaser">
                ...
                <div class="card service service-teaser">
                  <div class="card-content">
                    ...
                    <h3>Magazine<span class="status"></span></h3><a
                      ...
                      <h2 class="inline">The Archmerean</h2>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="card service service-teaser">
                  <div class="card-content">
                    ...
                    <h3>Photography Book<span class="status">in partnership with Brilliant Graphics</span></h3><a
                      ...
                      <h2 class="inline">Love Street</h2>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="card service service-teaser">
                  <div class="card-content">
                    ...
                    <h3>Brochure<span class="status">in partnership with Brilliant Graphics</span></h3><a
                      ...
                      <h2 class="inline">Color Dispersions Brochure</h2>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="card service service-teaser">
                  <div class="card-content">
                    ...
                    <h3>Catalog<span class="status"></span></h3><a
                      ...
                      <h2 class="inline">Perfume Bottle Auction</h2>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="card service service-teaser">
                  <div class="card-content">
                    ...
                    <h3>Photography Book<span class="status">in partnership with Brilliant Graphics</span></h3><a
                      ...
                      <h2 class="inline">Seeing the Sourlands</h2>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="card service service-teaser">
                  <div class="card-content">
                    ...
                    <h3>Catalog<span class="status"></span></h3><a
                      ...
                      <h2 class="inline">Hartzell's Auction Gallery</h2><span> | </span>
                      <h2 class="inline">The Iron Collection</h2>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="container">
            <div class="row">
              <div class="footer-logo col-md-1"><a href="https://<?php echo DOMAIN; ?>/"><img class="footer-logo-image"
                    src="./portfolio_files/fifteen-east-logo-grey.svg"></a></div>
              <div class="col">
                <div class="row">
                  <div class="col-12">
    ...
    <div id="gatsby-announcer"
      ...
      aria-live="assertive" aria-atomic="true">Navigated to the good people who do good work that we keep talking
      about...</div>
  </div>
  <script async="" src="./portfolio_files/js"></script>
  <script>
  ...
  <script src="./portfolio_files/polyfill-7b348442928a6932f9e3.js" nomodule=""></script>
  <script src="./portfolio_files/component---src-pages-index-js-c42c1743ea4d36556642.js" async=""></script>
  <script src="./portfolio_files/d4ad233efeb1d959420253442063e6db7488fdeb-54bbfad46877c3bb23dd.js" async=""></script>
  <script src="./portfolio_files/commons-b1feb129729e34a11e63.js" async=""></script>
